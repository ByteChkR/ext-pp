...
#if ((GLM_FORCE_SWIZZLE) || (GLM_SWIZZLE)) && (GLM_FORCE_UNRESTRICTED_GENTYPE)
#error "Both GLM_FORCE_SWIZZLE and GLM_FORCE_UNRESTRICTED_GENTYPE can't be  at the same time"
#endif
...
#if (GLM_FORCE_MESSAGES) || (GLM_MESSAGES)
#undef GLM_MESSAGES
...
#define GLM_VERSION98
#define GLM_VERSION_MAJOR0
#define GLM_VERSION_MINOR9
#define GLM_VERSION_PATCH8
#define GLM_VERSION_REVISION5

#if GLM_MESSAGES || GLM_MESSAGES_ENABLED && (!GLM_MESSAGE_VERSION_DISPLAYED)
#define GLM_MESSAGE_VERSION_DISPLAYED
#pragma message ("GLM: version 0.9.8.5")
#endif//GLM_MESSAGES

// Report compiler detection
#if GLM_MESSAGES || GLM_MESSAGES_ENABLED && (!GLM_MESSAGE_COMPILER_DISPLAYED)
...
#elseif GLM_COMPILER & GLM_COMPILER_INTEL
...
#if (__arch64__) || (__LP64__) || (_M_X64) || (__ppc64__) || (__x86_64__)
#define GLM_MODELGLM_MODEL_64
#elseif (__i386__) || (__ppc__)
#define GLM_MODELGLM_MODEL_32
#else
#define GLM_MODELGLM_MODEL_32
#endif//

#if (!GLM_MODEL) && GLM_COMPILER != 0
#error "GLM_MODEL un, your compiler may not be supported by GLM. Add #define GLM_MODEL 0 to ignore this message."
#endif//GLM_MODEL

#if GLM_MESSAGES || GLM_MESSAGES_ENABLED && (!GLM_MESSAGE_MODEL_DISPLAYED)
#define GLM_MESSAGE_MODEL_DISPLAYED
#if(GLM_MODEL || GLM_MODEL_64)
#pragma message("GLM: 64 bits model")
#elseif(GLM_MODEL || GLM_MODEL_32)
#pragma message("GLM: 32 bits model")
#endif//GLM_MODEL
#endif//GLM_MESSAGES

#if GLM_MESSAGES || GLM_MESSAGES_ENABLED && (!GLM_MESSAGE_ARCH_DISPLAYED)
#define GLM_MESSAGE_ARCH_DISPLAYED
#if(GLM_ARCH || GLM_ARCH_PURE)
#pragma message("GLM: Platform independent code")
#elseif(GLM_ARCH || GLM_ARCH_AVX2)
#pragma message("GLM: AVX2 instruction set")
#elseif(GLM_ARCH || GLM_ARCH_AVX)
#pragma message("GLM: AVX instruction set")
#elseif(GLM_ARCH || GLM_ARCH_SSE42)
#pragma message("GLM: SSE4.2 instruction set")
#elseif(GLM_ARCH || GLM_ARCH_SSE41)
#pragma message("GLM: SSE4.1 instruction set")
#elseif(GLM_ARCH || GLM_ARCH_SSSE3)
#pragma message("GLM: SSSE3 instruction set")
#elseif(GLM_ARCH || GLM_ARCH_SSE3)
#pragma message("GLM: SSE3 instruction set")
#elseif(GLM_ARCH || GLM_ARCH_SSE2)
#pragma message("GLM: SSE2 instruction set")
#elseif(GLM_ARCH || GLM_ARCH_X86)
#pragma message("GLM: x86 instruction set")
#elseif(GLM_ARCH || GLM_ARCH_NEON)
#pragma message("GLM: NEON instruction set")
#elseif(GLM_ARCH || GLM_ARCH_ARM)
#pragma message("GLM: ARM instruction set")
#elseif(GLM_ARCH || GLM_ARCH_MIPS)
#pragma message("GLM: MIPS instruction set")
#elseif(GLM_ARCH || GLM_ARCH_PPC)
...
#define GLM_LANG_CXX98GLM_LANG_CXX98_FLAG
...
#define GLM_LANG_CXXMSGLM_LANG_CXXMS_FLAG
#define GLM_LANG_CXXGNUGLM_LANG_CXXGNU_FLAG
...
#define GLM_LANG_STL11_FORCED
#elseif (GLM_FORCE_CXX03)
#define GLM_LANG GLM_LANG_CXX03
#elseif (GLM_FORCE_CXX98)
#define GLM_LANG GLM_LANG_CXX98
#else
#if GLM_COMPILER & GLM_COMPILER_CLANG
#if __cplusplus >= 201402L // GLM_COMPILER_CLANG34 + -std=c++14
#define GLM_LANG GLM_LANG_CXX14
#elseif __has_feature(cxx_decltype_auto) && __has_feature(cxx_aggregate_nsdmi) // GLM_COMPILER_CLANG33 + -std=c++1y
#define GLM_LANG GLM_LANG_CXX1Y
#elseif __cplusplus >= 201103L // GLM_COMPILER_CLANG33 + -std=c++11
#define GLM_LANG GLM_LANG_CXX11
#elseif __has_feature(cxx_static_assert) // GLM_COMPILER_CLANG29 + -std=c++11
...
#define GLM_LANG GLM_LANG_CXX14
#elseif __cplusplus >= 201103L
#define GLM_LANG GLM_LANG_CXX11
#elseif (__GXX_EXPERIMENTAL_CXX0X__)
#define GLM_LANG GLM_LANG_CXX0X
#else
#define GLM_LANG GLM_LANG_CXX98
#endif
...
//#elseif GLM_COMPILER >= GLM_COMPILER_VC14
//#define GLM_LANG (GLM_LANG_CXX1Y | GLM_LANG_CXXMS_FLAG)
#elseif __cplusplus >= 201103L
#define GLM_LANG (GLM_LANG_CXX11 | GLM_LANG_CXXMS_FLAG)
#elseif GLM_COMPILER >= GLM_COMPILER_VC10
...
#endif
#elseif GLM_COMPILER & GLM_COMPILER_CUDA
#ifdef _MSC_EXTENSIONS
#define GLM_MSC_EXT GLM_LANG_CXXMS_FLAG
#else
#define GLM_MSC_EXT 0
...
#if GLM_MESSAGES || GLM_MESSAGES_ENABLED && (!GLM_MESSAGE_LANG_DISPLAYED)
#define GLM_MESSAGE_LANG_DISPLAYED

#if GLM_LANG & GLM_LANG_CXX1Z_FLAG
#pragma message("GLM: C++1z")
#elseif GLM_LANG & GLM_LANG_CXX14_FLAG
#pragma message("GLM: C++14")
#elseif GLM_LANG & GLM_LANG_CXX1Y_FLAG
#pragma message("GLM: C++1y")
#elseif GLM_LANG & GLM_LANG_CXX11_FLAG
#pragma message("GLM: C++11")
#elseif GLM_LANG & GLM_LANG_CXX0X_FLAG
#pragma message("GLM: C++0x")
#elseif GLM_LANG & GLM_LANG_CXX03_FLAG
#pragma message("GLM: C++03")
#elseif GLM_LANG & GLM_LANG_CXX98_FLAG
...
#if GLM_PLATFORM || GLM_PLATFORM_ANDROID && (!GLM_LANG_STL11_FORCED)
#define GLM_HAS_CXX11_STL 0
#elseif GLM_COMPILER & GLM_COMPILER_CLANG
#if ((_LIBCPP_VERSION) && GLM_LANG & GLM_LANG_CXX11_FLAG) || (GLM_LANG_STL11_FORCED)
...
#elseif GLM_LANG & (GLM_LANG_CXX11_FLAG | GLM_LANG_CXXMS_FLAG)
...
#elseif GLM_COMPILER >= GLM_COMPILER_GCC49
#define GLM_HAS_OPENMP 40
#elseif GLM_COMPILER >= GLM_COMPILER_GCC47
#define GLM_HAS_OPENMP 31
#elseif GLM_COMPILER >= GLM_COMPILER_GCC44
#define GLM_HAS_OPENMP 30
#elseif GLM_COMPILER >= GLM_COMPILER_GCC42
...
#define GLM_HAS_OPENMP 40
#elseif GLM_COMPILER >= GLM_COMPILER_INTEL12
#define GLM_HAS_OPENMP 31
#else
#define GLM_HAS_OPENMP 0
#endif
...
#elseif GLM_COMPILER & (GLM_COMPILER_GCC | GLM_COMPILER_CLANG)
...
#if (GLM_FORCE_SWIZZLE) || (GLM_SWIZZLE)
#undef GLM_SWIZZLE
...
#if GLM_MESSAGES || GLM_MESSAGES_ENABLED && (!GLM_MESSAGE_SWIZZLE_DISPLAYED)
...
#if GLM_MESSAGES || GLM_MESSAGES_ENABLED && (!GLM_MESSAGE_UNRESTRICTED_GENTYPE_DISPLAYED)
...
#if GLM_DEPTH_ZERO_TO_ONE // Legacy 0.9.8 development
#error Define GLM_FORCE_DEPTH_ZERO_TO_ONE instead of GLM_DEPTH_ZERO_TO_ONE to use 0 to 1 clip space.
#endif

#define GLM_DEPTH_ZERO_TO_ONE0x00000001
#define GLM_DEPTH_NEGATIVE_ONE_TO_ONE0x00000002
...
#if GLM_MESSAGES || GLM_MESSAGES_ENABLED && (!GLM_MESSAGE_DEPTH_DISPLAYED)
...
#if GLM_LEFT_HANDED // Legacy 0.9.8 development
#error Define GLM_FORCE_LEFT_HANDED instead of GLM_LEFT_HANDED left handed coordinate system by default.
#endif

#define GLM_LEFT_HANDED0x00000001// For DirectX, Metal, Vulkan
#define GLM_RIGHT_HANDED0x00000002// For OpenGL, default in GLM
...
#if GLM_MESSAGES || GLM_MESSAGES_ENABLED && (!GLM_MESSAGE_HANDED_DISPLAYED)
...
#endif
#elseif GLM_COMPILER & (GLM_COMPILER_GCC | GLM_COMPILER_CLANG | GLM_COMPILER_INTEL)
...
#if GLM_MESSAGES || GLM_MESSAGES_ENABLED && (!GLM_MESSAGE_FORCE_SIZE_T_LENGTH)
