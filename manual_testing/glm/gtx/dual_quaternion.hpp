...
///
/// @see gtx_dual_quaternion
typedef highp_fdualquatdualquat;

/// Dual-quaternion of single-precision floating-point numbers.
///
/// @see gtx_dual_quaternion
typedef highp_fdualquatfdualquat;
#elseif((GLM_PRECISION_HIGHP_FLOAT) && (!GLM_PRECISION_MEDIUMP_FLOAT) && (!GLM_PRECISION_LOWP_FLOAT))
typedef highp_fdualquatdualquat;
typedef highp_fdualquatfdualquat;
#elseif((!GLM_PRECISION_HIGHP_FLOAT) && (GLM_PRECISION_MEDIUMP_FLOAT) && (!GLM_PRECISION_LOWP_FLOAT))
typedef mediump_fdualquatdualquat;
typedef mediump_fdualquatfdualquat;
#elseif((!GLM_PRECISION_HIGHP_FLOAT) && (!GLM_PRECISION_MEDIUMP_FLOAT) && (GLM_PRECISION_LOWP_FLOAT))
typedef lowp_fdualquatdualquat;
typedef lowp_fdualquatfdualquat;
#else
...
///
/// @see gtx_dual_quaternion
typedef highp_ddualquatddualquat;
#elseif((GLM_PRECISION_HIGHP_DOUBLE) && (!GLM_PRECISION_MEDIUMP_DOUBLE) && (!GLM_PRECISION_LOWP_DOUBLE))
typedef highp_ddualquatddualquat;
#elseif((!GLM_PRECISION_HIGHP_DOUBLE) && (GLM_PRECISION_MEDIUMP_DOUBLE) && (!GLM_PRECISION_LOWP_DOUBLE))
typedef mediump_ddualquatddualquat;
#elseif((!GLM_PRECISION_HIGHP_DOUBLE) && (!GLM_PRECISION_MEDIUMP_DOUBLE) && (GLM_PRECISION_LOWP_DOUBLE))
typedef lowp_ddualquatddualquat;
#else
