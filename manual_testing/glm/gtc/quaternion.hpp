...
/// @param a Interpolation factor. The interpolation is  beyond the range [0, 1].
...
/// @param x A quaternion
/// @param y A quaternion
/// @param a Interpolation factor. The interpolation is  in the range [0, 1].
/// @tparam T Value type used to build the quaternion. Supported: half, float or double.
/// @see gtc_quaternion
template <typename T, precision P>
...
/// The result is expressed in radians if GLM_FORCE_RADIANS is  or degrees otherwise.
/// 
/// @see gtc_quaternion
template <typename T, precision P>
